                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="password" class="form-control" placeholder="ادخل إسم التخصص " name="password">
                                            </div>
                                    </div> 
                                    <div class="form-group">
                                            <label class="col-md-3 control-label">إسم التخصص</label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="ادخل إسم التخصص " name="phone">
                                                </div>
                                        </div>  
                                    </form>
                                </div>
