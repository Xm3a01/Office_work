             ...
             <form class="form-horizontal" id="user-form" role="form" method="POST" action="{{route('cv.update' , $education->id)}}">
                ...
                <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                    <input type="text" class="form-control" name="university" value="{{$education->ar_univiersity}}" placeholder="مثال: جامعة الجزيرة" id="">
                            </div>
                        </div>
                            ...
                            <label class="col-md-2 control-label">التخصص</label>
                                <div class="col-md-4">
                                    <select class="form-control" name="special_id">
                                            ...
                                            <option value="{{$sub->id}}"  {{($sub->ar_name == $education->ar_sub_special) ? 'selected' : ''}}>{{$sub->ar_name}}</option>
